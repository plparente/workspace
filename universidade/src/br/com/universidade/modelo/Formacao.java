...
/*
 * Polimorfismo: métodos com o mesmo nome e ações diferentes;
 * Overload (sobrecarga): quando os métodos estão na mesma classe
 * Override (sobreescrita): quando os métodos estão em classes diferentes
 * 
 */
