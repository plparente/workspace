...
public class ManipulaString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Do 2º ao 4º: " + email.substring(1,4));
		System.out.println("A partir do 2º: " + email.substring(1));
		System.out.println("Usuario: " + email.substring(0,email.indexOf("@")));
		System.out.println("Servidor: " + email.substring(email.indexOf("@")));
		System.out.println("Servidor principal: " + email.substring(email.indexOf("@")+1,email.indexOf(".com.br")));
		//retorna somente o servidor
		System.out.println("Primeira metade: " + email.substring(0, email.length()/2));
		// traz a primeira metade do email
